...
**Imagify Image-resizer** – compress images<br>
**Cloudconvert Image-converter** - change format of images<br>
...
**Python** - python 3 via terminal to preview my site using a local http server<br>
**HTML5** - build the core of the site<br>
**CSS** - style the website and define fonts and layout<br>
...
Some bugs were found when performing the Wabe tests. Corresponding to the lines of code:
